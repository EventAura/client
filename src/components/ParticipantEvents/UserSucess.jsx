              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                <div className="text-center sm:text-left">
                  <h1 className="text-xl font-semibold text-gray-100 sm:text-2xl">
                    ...
                    <span className="text-indigo-600">{data?.eventName}</span>{" "}
                    event ! 🎉
                  </h1>
                  <p className="mt-1.5 text-sm text-gray-200">
                    Navigate to the page to know more or check mail for detailed
                    information{" "}
                    <span className=" font-semibold text-red-600">
                      Don't forget to download the tickect
                    </span>
                  </p>
                </div>
          ...
          <div className="flow-root rounded-lg border py-3 shadow-sm border-gray-700 mx-7 sm:mx-20">
            <dl className="-my-3 divide-y text-sm divide-gray-700">
              ...
              <div className="grid grid-cols-1 gap-1 p-3 sm:grid-cols-3 sm:gap-4">
                ...
                <dd className="sm:col-span-2 text-gray-100">{data?.name}</dd>
              </div>
              <div className="grid grid-cols-1 gap-1 p-3 sm:grid-cols-3 sm:gap-4">
              ...
              <div className="grid grid-cols-1 gap-1 p-3 sm:grid-cols-3 sm:gap-4">
                ...
                <dd className="sm:col-span-2 text-gray-100">{data.email}</dd>
              </div>
              <div className="grid grid-cols-1 gap-1 p-3 sm:grid-cols-3 sm:gap-4">
